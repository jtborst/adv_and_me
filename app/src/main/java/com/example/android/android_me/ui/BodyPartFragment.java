...
public class BodyPartFragment extends Fragment {
    ...
    private final String stateImageList = "state_image_list";
    private final String stateIndex = "state_index";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            mImageIds = savedInstanceState.getIntegerArrayList(stateImageList);
            mListIndex = savedInstanceState.getInt(stateIndex);
        }
    ...
    public void onSaveInstanceState(Bundle outState) {
        outState.putIntegerArrayList(stateImageList, (ArrayList<Integer>) mImageIds);
        outState.putInt(stateIndex, mListIndex);
